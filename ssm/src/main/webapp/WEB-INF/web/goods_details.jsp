...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="${pageContext.request.contextPath}${goods.image }" width="460px" height="360px;"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        ...
        <p>
            <s>规格：</s><br/>
	            ...
	            <span class="${goodsList.id == goods.id?'avenge borderChange':'avenge' }"  onclick="showGoodsDetailss(${goodsList.id})">${goodsList.title }</span><br/>
            	</c:forEach>
        </p>
        <!-- 未选择规格，颜色时状态-->
        <div class="message"></div>
          ...
          <!-- 隐藏标签 -->
	    <form  id="buyForm" style="display:hidden;" >
		    	<input type="hidden" 
				...
				<input type="hidden" 
				name="goodsCount" id="goodsCount" value="1" />
	    </form>
        <!-- 购买部分-->
        <div class="shops">
            <a href="##" class="buy lf" id="buy_now" onclick="buyNow(${goods.id })">立即购买</a>
            <a href="##" class="shop lf" onclick="addCart(${goods.id })" id="add_cart" ><img src="../images/product_detail/product_detail_img7.png"  alt=""/>加入购物车</a>
            <a href="##${goods.id}" class="collection lf" id="collect"><span>收藏</span></a><b><img src="../images/product_detail/product_detail_img6.png"                                                                       alt=""/></b>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function buyNow(id){
    	...
    	location.href="cart.html?id="+id+"&num="+num;
    }
</script>
<!--图片效果-->
<script>
...
<script>
    ...
    function addCart(id){
    	alert(1);
    	var url = "${pageContext.servletContext.contextPath}/cart/add.do";
