...
<header id="top" class="fixed_nav">
	...
	<div class="rt">
		<ul class="lf">
			<c:if test="${uid != null}">
				<li>
					<a href="${pageContext.request.contextPath}/user/profile.do">${username}</a><b>|</b>
				</li>
			</c:if>
			...
			<li><a href="${pageContext.request.contextPath}/cart/list.do" title="我的购物车"><img class="shopcar"
...
<nav id="nav">
	<ul>
		<li><a href="${pageContext.servletContext.contextPath }/main/index.do" class="acti">首页</a></li>
