...
<div id="leftsidebar_box" class="lf">
	...
	<dl class="address">
		...
		<dd>
			<a href="${pageContext.request.contextPath}/address/list.do">地址管理</a>
		</dd>
	</dl>
	<dl class="count_managment">
		...
		<dd class="first_dd">
			<a href="${pageContext.request.contextPath}/user/profile.do">我的信息</a>
		</dd>
		<dd>
			<a href="#">个人头像</a>
		</dd>
		<dd>
			<a href="${pageContext.request.contextPath}/user/password.do">安全管理</a>
		</dd>
	</dl>
</div>