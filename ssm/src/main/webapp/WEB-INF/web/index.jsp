...
<body>
	...
	<div class="lf1">
		...
		<div class="lf1_bottom">
			<div class="item_cat lf">
				...
				<div class="item_cat_all">
		            	...
		            	<ul>
		            		...
		            		<li><a href="${pageContext.request.contextPath }/goods/list.do?category_id=${category.id}">${category.name }</a>
		            		</c:forEach>
		            	</ul>
			...
			<!-- 显示最佳电脑前三的信息 -->
			<c:forEach var="goods"  items="${category163 }">
				<div class="item_msg lf">
					<img width="190" height="130"  src="..${goods.image }" alt="" />
