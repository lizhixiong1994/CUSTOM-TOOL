					...
					<div id="box">
								...
								<div class="imfor">
									...
									<div class="pudc">
										<div class="pudc_information" id="pudcId3">
											<img
												...
												class="lf" style="width: 100px; height: 80px;'" /> <input
									...
									<div class="pices">
										...
										<p class="pices_information">
											<b>￥</b><span>${cart.goodsPrice }<input type="hidden"
												name="" value=""></span>
										</p>
									</div>
									<div class="num">
									...
									<div class="totle">
										<span>￥</span> <span class="totle_information">${cart.goodsPrice*cart.goodsCount }</span>
									</div>
									<div class="del">
										<!-- <div>
						...
						<div class="foot">
							...
							<div class="foot_cash" id="go-buy">
								<input class="submit" type="submit" value="去结算"></input>
							</div>
							<div class="foot_tol">
