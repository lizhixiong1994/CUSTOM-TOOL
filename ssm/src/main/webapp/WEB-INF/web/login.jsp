    ...
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                ...
                <div class="text">
                    <input style="width:80px;height:18px;margin:0 20px 0 0;float:left;" type="text"placeholder="请输入验证码" id="captcha" >
                    <img alt="" src="code.do" onclick="this.src='code.do?'+Math.random()"> 
                </div>
                <div class="chose">
...
//如果，则自动登录
    ...
    function saveCookie() {
        ...
        if (checked) {
            ...
            $.cookie("rmbUser", "false", { expire: -1 });//清除cookie的数据，并设置为过期
