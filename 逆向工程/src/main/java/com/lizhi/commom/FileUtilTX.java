...
public class FileUtilTX {
	 ...
	 * @param listFile
	 */
	public static void upload(Map<String, File> listFile,Map<String, InputStream> listStream) {
		if (cosclient == null) {
			throw new RuntimeException("cosclient没有设定初始");
		}
		...
		Set<Entry<String, InputStream>> entrySet1 = listStream.entrySet();
		for (Entry<String, InputStream> entry : entrySet1) {
			upload(entry.getKey(), entry.getValue());
		}
	}
	...
	public static void main(String[] args) {
		...
		InputStream resourceAsStream = FileUtilTX.class.getResourceAsStream("mydown.jpg");
